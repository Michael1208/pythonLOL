...
async def botinfo(ctx):
    ...
    embed.add_field(name='Kyle♡#1849', value='Kyle Is Just An Average Guy Born On December 9th 2004 Who Likes To Code And Use Discord', inline=True)
    embed.add_field(name='Michael♡#3910', value='Michael Is Again Just An Average Guy Who Likes Coding Born June 8th 2005', inline=True)
